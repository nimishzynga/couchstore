...
LIBCOUCHSTORE_API
couchstore_error_t couchstore_handle_query_request1(view_group_info_t *info,
                                                   sized_buf *header_buf,
                                                   couchfile_lookup_request *rq1,
...

{
    ...
    couchfile_lookup_request rq = *rq1;
